...
CKeystone::CKeystone(TCHAR     *pName,
	...
	HRESULT hr = S_OK;
	m_pVideo = new CKeystoneVideoPin(NAME("Video Pin"), this, &hr, L"Video");
	m_pOutput = new CKeystoneOutputPin(NAME("Output Pin"), this, &hr, L"Output");
...
CBasePin * CKeystone::GetPin(int n)
{
    ...
    if (m_pVideo == NULL) 
    {
        ...
        if (m_pVideo == NULL) 
        {
         ...
         // The lone output pin
        m_pOutput = new CKeystoneOutputPin(NAME("Output pin"), this, &hr, L"Out" );   
