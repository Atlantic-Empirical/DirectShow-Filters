...
//------------------------------------------------------------------------------
// { fd501076-8ebe-11ce-8183-00aa00577da1 }
DEFINE_GUID(CLSID_BouncingBall,
0xfd501076, 0x8ebe, 0x11ce, 0x81, 0x83, 0x00, 0xaa, 0x00, 0x57, 0x7d, 0xa1);
...
public:
    ...
    CBall(int iImageWidth = 1920, int iImageHeight = 1080, int iBallSize = 10);
