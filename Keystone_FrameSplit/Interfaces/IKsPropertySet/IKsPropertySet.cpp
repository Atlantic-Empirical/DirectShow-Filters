...
//// IKsPropertySet
//
//STDMETHODIMP CKeystone::Set(REFGUID PropSet, ULONG Id, LPVOID pInstanceData, ULONG InstanceLength, LPVOID pPropertyData, ULONG DataLength)
//{
...
//}
//
//STDMETHODIMP CKeystone::Get(REFGUID PropSet, ULONG Id, LPVOID pInstanceData, ULONG InstanceLength, LPVOID pPropertyData, ULONG DataLength, ULONG* pBytesReturned)
//{
//	if(PropSet == AM_KSPROPSETID_CopyProt && Id == AM_PROPERTY_COPY_MACROVISION
//	/*&& DataLength == 4 && *(DWORD*)pPropertyData*/)
//	{
...
//}
//
//STDMETHODIMP CKeystone::QuerySupported(REFGUID PropSet, ULONG Id, ULONG* pTypeSupport)
//{
//	if(PropSet == AM_KSPROPSETID_CopyProt && Id == AM_PROPERTY_COPY_MACROVISION
//	/*&& DataLength == 4 && *(DWORD*)pPropertyData*/)
//	{
