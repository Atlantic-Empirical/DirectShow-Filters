...
// =================================================================
// Implements the CKeystoneVideoOnePin class
// =================================================================

// constructor
CKeystoneVideoOnePin::CKeystoneVideoOnePin(
    TCHAR *pObjectName,
...
{
    DbgLog((LOG_TRACE,2,TEXT("CKeystoneVideoOnePin::CKeystoneVideoOnePin")));
...
STDMETHODIMP CKeystoneVideoOnePin::NonDelegatingQueryInterface(REFIID riid, void** ppv)
{
...
HRESULT CKeystoneVideoOnePin::CheckConnect(IPin *pPin)
{
    return CBaseInputPin::CheckConnect(pPin);
}

// provides derived filter a chance to release it's extra interfaces
HRESULT CKeystoneVideoOnePin::BreakConnect()
{
...
HRESULT CKeystoneVideoOnePin::CompleteConnect(IPin *pReceivePin)
{
    return CBaseInputPin::CompleteConnect(pReceivePin);
}

// check that we can support a given media type
HRESULT CKeystoneVideoOnePin::CheckMediaType(const CMediaType* pmt)
{
	////nVidia
...
HRESULT CKeystoneVideoOnePin::SetMediaType(const CMediaType* mtIn)
{
	//debugging
...
HRESULT CKeystoneVideoOnePin::GetMediaType(int iPosition, CMediaType* pMediaType)
{
	////nVidia
...
STDMETHODIMP  CKeystoneVideoOnePin::QueryAccept(const AM_MEDIA_TYPE* pmt)
{
	return __super::QueryAccept(pmt);
}

STDMETHODIMP CKeystoneVideoOnePin::ReceiveConnection(IPin* pConnector, const AM_MEDIA_TYPE* pmt)
{
...
STDMETHODIMP CKeystoneVideoOnePin::EndOfStream(void)
{
...
STDMETHODIMP CKeystoneVideoOnePin::BeginFlush(void)
{
...
STDMETHODIMP CKeystoneVideoOnePin::EndFlush(void)
{
...
STDMETHODIMP CKeystoneVideoOnePin::NewSegment( REFERENCE_TIME tStart, REFERENCE_TIME tStop, double dRate)
{
...
HRESULT CKeystoneVideoOnePin::Receive(IMediaSample * pSample)
{
	//Beep(1000,1);
	//return m_pTransformFilter->MixAndDeliverVideo(pSample, 1920, 1080);
...
//
	...
	//pSample->Release();
	return m_pTransformFilter->MixAndDeliverVideo(pOut, 1920, 1080);
...
//
//	return m_pTransformFilter->ReceiveVideoTwo(pSample);
...
HRESULT CKeystoneVideoOnePin::ReceiveStep2(IMediaSample * pIn)
{
	HRESULT hr = S_OK;
...
HRESULT CKeystoneVideoOnePin::ThreeTwo(IMediaSample * pIn)
{
	RECT r1;
...
//}
//
HRESULT CKeystoneVideoOnePin::LogMPEGFlags(IMediaSample * pIn)
{
	//MPEG FLAGS
	IMediaSample2 * IMS2 = NULL;
	if (FAILED(pIn->QueryInterface(IID_IMediaSample2, (void**) &IMS2)))
...
HRESULT CKeystoneVideoOnePin::NonThreeTwoIOS(IMediaSample * pIn, RECT * r1, int CopyLine)
{
	HRESULT hr = S_OK;
    IMediaSample * pOut = NULL;
...
HRESULT CKeystoneVideoOnePin::ThreeTwoIOS(IMediaSample * pIn, RECT * r1, int CopyLine)
{
...
HRESULT CKeystoneVideoOnePin::ReceiveStep5(IMediaSample * pOut, RECT * r1, bool Is32Sample, int BottomSource, int TopSource)
{
...
HRESULT CKeystoneVideoOnePin::Resize(IMediaSample * pIn)
{
...
HRESULT CKeystoneVideoOnePin::CheckStreaming()
{
    ASSERT(m_pTransformFilter->m_pOutput != NULL);
...
STDMETHODIMP CKeystoneVideoOnePin::NotifyAllocator(IMemAllocator* pAllocator, BOOL bReadOnly)
{
	CAutoLock lock(m_pLock);
