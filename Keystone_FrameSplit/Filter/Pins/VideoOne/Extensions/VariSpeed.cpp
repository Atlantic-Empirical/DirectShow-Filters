...
#include "../VideoOnePin.h"

HRESULT CKeystoneVideoOnePin::ProcessVarispeedSample(IMediaSample * pVSSample)
{
	//Set time stamps
	//Beep(1000, 1);
...
HRESULT CKeystoneVideoOnePin::ActivateVarispeed(double Speed)
{
	bInVarispeed = true;
...
HRESULT CKeystoneVideoOnePin::DeactivateVarispeed()
{
	bInVarispeed = false;
