...
HRESULT CKeystoneVideoOnePin::ReverseFieldOrder(LPBYTE src, int h, int w, int pitch)
{
...
HRESULT CKeystoneVideoOnePin::BumpFieldsDown(LPBYTE src, int h, int w, int pitch, int Cnt, bool SetLinesBlack)
{
	LPBYTE tmp = (LPBYTE)malloc(h * pitch);
	m_pTransformFilter->CopyVidRect(src, tmp, pitch, w, h);
...
//HRESULT CKeystoneVideoOnePin::BumpFieldsDown(LPBYTE src, int h, int w, int pitch)
//{
//	LPBYTE tmp = (LPBYTE)malloc(h * pitch);
//	m_pTransformFilter->CopyVidRect(src, tmp, pitch, w, h);
//
