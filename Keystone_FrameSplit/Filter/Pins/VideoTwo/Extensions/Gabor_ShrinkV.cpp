...
bool CKeystoneVideoTwoPin::ShrinkV(LPBYTE dst, int dh, int dstpitch, LPBYTE src, int sh, int srcpitch, int wbytes)
{
...
bool CKeystoneVideoTwoPin::ShrinkV(LPBYTE dst, int dh, LPBYTE src, int sh, int w, BOOL bInterlaced)
{
	int pitch = w*2;
	int wbytes = w*2;
