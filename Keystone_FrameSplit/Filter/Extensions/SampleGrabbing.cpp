...
HRESULT CKeystone::HandleSampleGrab(IMediaSample *IMS)
{
	...
	switch (SampleWhat)
	{
		...
		case 0: //Video only
		{
			subtype = m_mtVideoOne.subtype;
			formattype = m_mtVideoTwo.formattype;
			pbFormat = m_mtVideoTwo.pbFormat;
			break;
		}
	...
	{
		VIDEOINFO * VI = (VIDEOINFO*) m_mtVideoTwo.Format();
