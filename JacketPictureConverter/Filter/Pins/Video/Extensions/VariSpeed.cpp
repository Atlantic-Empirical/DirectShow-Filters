...
HRESULT CKeystoneVideoPin::ProcessVarispeedSample(IMediaSample * pVSSample)
{
	//Set time stamps
	//Beep(1000, 1);
...
HRESULT CKeystoneVideoPin::ActivateVarispeed(double Speed)
{
	bInVarispeed = true;
...
HRESULT CKeystoneVideoPin::DeactivateVarispeed()
{
	bInVarispeed = false;
