...
//HRESULT CKeystoneVideoPin::Run32(IMediaSample* pIn)
//{
...
//HRESULT CKeystoneVideoPin::Populate32Buffer(bool Odd, LPBYTE src, LPBYTE dst)
//{
...
//HRESULT CKeystoneVideoPin::Deliver32Sample(IMediaSample* pIn, LPBYTE Buffer, int nBytes)
//{
//	HRESULT hr;
...
//HRESULT CKeystoneVideoPin::TurnOn32(IMediaSample * pIn)
//{
//	bRun32 = true;
...
//}
//
//HRESULT CKeystoneVideoPin::TurnOff32()
//{
//	bRun32 = false;
//	//Beep(1500, 1);
//	//this->s_buffer_empty = true;
